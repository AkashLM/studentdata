		...
		<Fragment>
			...
			<Collapse in={open}>
				<Container>
					<Form>
						<Row className="g-2">
							<h3 style={{ disply: 'flex', justifyContent: 'right' }}>SSC Details:</h3>
							<Col md>
								<FloatingLabel controlId="floatingInputName" label="English Marks" className="mb-3">
									<Form.Control
							...
							<Col md>
								<FloatingLabel controlId="floatingInputName" label="Science Marks" className="mb-3">
									<Form.Control
							...
							<Col md>
								<FloatingLabel controlId="floatingInputName" label="Math Marks" className="mb-3">
									<Form.Control
							...
							<Col md>
								<FloatingLabel controlId="floatingInputName" label="Total Marks" className="mb-3">
									<Form.Control
										onChange={(e) => {
											setSchoolDetails((prev) => {
						...
						<Row className="g-2">
							...
							<Col md>
								<FloatingLabel controlId="floatingInputName" label="Physics Marks" className="mb-3">
									<Form.Control
							...
							<Col md>
								<FloatingLabel controlId="floatingInputName" label="Chemistry Marks" className="mb-3">
									<Form.Control
						...
						<Row className="g-2">
							<Col className="mb-3" md>
								<FloatingLabel defaultValue={examType} controlId="floatingSelect" label="Exam Type ">
									<Form.Select
										onChange={(e) => {
							...
							<FloatingLabel controlId="floatingInputName" label=" School Name" className="mb-3">
								<Form.Control
							...
							<FloatingLabel controlId="floatingInputName" label=" Coaching Class" className="mb-3">
								<Form.Control
						...
						<div className="col-md-12 text-center">
							<Button onClick={onSubmitHandler} className=" mt-3 mb-3" type="button" variant="primary">
								submit
							</Button>
						</div>
					</Form>
